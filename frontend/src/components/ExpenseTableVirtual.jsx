...
const ExpenseTableVirtual = ({
  ...
  }, [projectId, view, search, searchField, sort, uncatOnly, miscatOnly, unsetOnly, suggestedOnly, refreshNonce]);
    ...
    <div className="spreadsheet relative h-[calc(100vh-202px)]">
      ...
      <div className="overflow-auto" style={{ height: 'calc(100% - 5px)' }}>
        <VirtualInfiniteScroll
          key={`${projectId}-${view}-${search}-${searchField}-${sort}-${uncatOnly}-${miscatOnly}-${unsetOnly}-${suggestedOnly}-${refreshNonce}`}
